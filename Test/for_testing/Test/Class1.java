...
public class Class1 extends MWComponentInstance<Class1>
{
    ...
    /**
     * Maintains information used in calling the <code>plot_states_historic</code> MATLAB 
     *function.
     */
    private static final MWFunctionSignature sPlot_states_historicSignature =
        new MWFunctionSignature(/* max outputs = */ 1,
                                /* has varargout = */ true,
                                /* function name = */ "plot_states_historic",
                                /* max inputs = */ 1,
                                /* has varargin = */ true);
    ...
    {
        this(TestMCRFactory.newInstance());
    }
    ...
    {
        this(TestMCRFactory.newInstance(getPathToComponentOptions(pathToComponent)));
    }
    ...
    {
        this(TestMCRFactory.newInstance(componentOptions));
    }
    ...
    {
        try {
            MWMCR mcr = TestMCRFactory.newInstance();
            mcr.runMain( sPlot_states_historicSignature, args);
            mcr.dispose();
        } catch (Throwable t) {
            t.printStackTrace();
        }
    ...
    /**
     * Provides the interface for calling the <code>plot_states_historic</code> MATLAB function 
     ...
     * @throws MWException An error has occurred during the function call.
     */
    public void plot_states_historic(List lhs, List rhs) throws MWException
    {
        fMCR.invoke(lhs, rhs, sPlot_states_historicSignature);
    }
     ...
     * @throws MWException An error has occurred during the function call.
     */
    public void plot_states_historic(Object[] lhs, Object[] rhs) throws MWException
    {
        fMCR.invoke(Arrays.asList(lhs), Arrays.asList(rhs), sPlot_states_historicSignature);
    }

    /**
     * Provides the standard interface for calling the <code>plot_states_historic</code> MATLAB function with 
     ...
     * @throws MWException An error has occurred during the function call.
     */
    public Object[] plot_states_historic(int nargout, Object... rhs) throws MWException
    {
        Object[] lhs = new Object[nargout];
        fMCR.invoke(Arrays.asList(lhs), 
                    MWMCR.getRhsCompat(rhs, sPlot_states_historicSignature), 
                    sPlot_states_historicSignature);
        return lhs;
    }
}
